...
public class Product implements Serializable{
	...
	//This method applied for association product vS categories if was in category the inverse
	@ManyToMany
	...
	@OneToMany(mappedBy = "id.product") //Mapped (id=Order Item PK and Product is id inside Order Item PK
