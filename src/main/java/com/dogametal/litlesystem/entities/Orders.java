...
public class Orders implements Serializable {
	...
	@OneToMany(mappedBy = "id.order") //Inside class OrderItem id was set up to PK auxiliary class field order as fpk
	private Set<OrderItem> items = new HashSet<>();
	
	//Method applied to use the same id for both tables Order and Payment
